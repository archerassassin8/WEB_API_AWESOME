...
public class UnityHTTPRequest : MonoBehaviour
{
    ...
    IEnumerator MakeWebRequestSingle()
    {
        ...
        MyData myData = JsonUtility.FromJson<MyData>(getRequest.downloadHandler.text);
        nameEdit.text = myData.myName;
        scoreEdit.text = myData.myScore.ToString();
        healthEdit.text = myData.myHealth.ToString();
    ...
    public void EditScore()
    {
        ...
        float score = float.Parse(scoreEdit.text);
        score += 50;
        scoreEdit.text = score.ToString();
    ...
    public void EditHealth()
    {
        ...
        float health = float.Parse(healthEdit.text);
        health -= 10;
        healthEdit.text = health.ToString();
